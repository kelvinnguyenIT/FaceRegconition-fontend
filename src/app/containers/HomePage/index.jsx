                ...
                <div className='absolute top-0 right-0 bottom-0 left-0 w-full h-full overflow-hidden bg-fixed'>
                  <div className='flex justify-center items-center h-full'>
                    <div className='text-white text-center px-14 px-md-0'>
                      ...
                      <h5 className='text-xl font-semibold mb-6 font-montserrat'>
                      ...
                      <div className='md:space-x-2'>
                        <Link to='/login'>
                          <button
                            className='inline-block px-6 py-3 mb-2 md:mb-0 border-2 border-white text-white font-montserrat font-medium text-sm leading-tight uppercase rounded hover:bg-[#ff1d53] focus:outline-none focus:ring-0 transition duration-150 ease-in-out'
                            href='#!'
                            role='button'
      ...
      <div className='bg-[#252d40]'>
        <div className='container mx-auto'>
          <section className=' text-gray-800 text-center lg:text-left'>
            <div className='block rounded-lg shadow-lg text-white'>
              <div className='flex flex-wrap items-center'>
                <div className='block w-full lg:flex grow-0 shrink-0 basis-auto lg:w-6/12 xl:w-4/12'>
                  <img
                    ...
                    className='w-full h-[600px] rounded-t-lg lg:rounded-tr-none lg:rounded-bl-lg'
                  />
                </div>
                <div className='grow-0 shrink-0 basis-auto w-full lg:w-6/12 xl:w-8/12'>
                  <div className='px-6 py-12 md:px-12'>
                    <h2 className='text-3xl font-bold mb-4 font-montserrat display-5'>
                      APPLICATIONS AND FEATURES
                    </h2>
                    <p className='text-[#9197a4] mb-12 font-montserrat'>
                      We have divided the product application areas into three
                      categories, but they are very similar: HR, marketing, and
                      security.
                    </p>

                    <div className='grid lg:gap-x-12 md:grid-cols-3 font-montserrat'>
                      <div className='mb-12 md:mb-0'>
                        <h2 className='text-base font-bold text-[#ff1d53] mb-4 font-montserrat'>
                          HUMAN RESOURCES (HR)
                        </h2>
      ...
      <div className='bg-[#171d2c] py-20'>
        <div className='container px-6 mx-auto'>
          <section className='text-gray-800'>
            <h2 className='text-3xl font-bold mb-3 text-center text-white font-montserrat'>
              INDUSTRY SOLUTIONS
            </h2>
            <p className='text-base mb-14 text-center text-[#9197a4] font-montserrat'>
            ...
            <div className='grid lg:grid-cols-3 gap-6'>
              <div
                className='zoom shadow-lg rounded-lg relative overflow-hidden bg-no-repeat bg-cover hover:scale-105 hover:transition-transform'
                data-mdb-ripple='true'
              ...
              >
                <img
                  ...
                  className='w-full h-full brightness-75 transition duration-300 ease-linear align-middle'
                />
                <a href='#'>
                  <div className='absolute top-0 right-0 bottom-0 left-0 w-full h-full overflow-hidden bg-fixed'>
                    <div className='flex justify-start items-end h-full'>
                      <h5 className='text-xl font-bold text-white m-6 font-montserrat'>
                        Company
                      </h5>
                    </div>
                  </div>
